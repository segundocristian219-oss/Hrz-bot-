const devsCommand = {
    ...
    run: async (m, { conn }) => {
        ...
        // --- 4. DESARROLLADOR 4 ---
        const myNumber4 = '584228028583'
        const myJid4 = myNumber4 + '@s.whatsapp.net'
        const brandName4 = 'ϛαριϛυγ ♛' 
        ...
        // --- 6. DESARROLLADOR 6 ---
        const myNumber6 = '584228028583'
        const myJid6 = myNumber6 + '@s.whatsapp.net'
        const brandName6 = 'ϛαριϛυγ ♛' 
        ...
        // --- 7. DESARROLLADOR 7 ---
        const myNumber7 = '584228028583'
        const myJid7 = myNumber7 + '@s.whatsapp.net'
        const brandName7 = 'ϛαριϛυγ ♛' 
