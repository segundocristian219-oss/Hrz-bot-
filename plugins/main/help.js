            ...
            const categories = [
                {
                    ...
                    cmds: [
                        ...
                        { cmd: '.stop', desc: 'Detener y eliminar la sección como subbot.' },
                ...
                },
                {
                    ...
                    cmds: [
                        ...
                        { cmd: '.palabra', desc: 'Adivina la palabra.' },            { cmd: '.perfil', desc: 'Muestra tu perfil.' },             { cmd: '.apostar', desc: 'Apuesta en el casino.' },          { cmd: '.trabajar', desc: 'Trabaja para ganar $col.' },
                    ]
                },
                {
                    title: 'ANIME',
                ...
                },
                {
                    ...
                    cmds: [
                       // { cmd: '.antisub', desc: 'Activa/desactiva anti-sub (evita que se unan números sospechosos).' },
                        ...
                        { cmd: '.warnlist', desc: 'Lista de usuarios con advertencia.' },
                        { cmd: '.warnlimit'. desc: 'Establece un limite de advertencias ```(solo admin)```.' }
                    ]
                },
                {
                    title: 'STICKERS',
