    ...
    sock.ev.on('messages.upsert', async (chatUpdate) => {
        try {
            ...
            for (let msg of chatUpdate.messages) {
                ...
                if (msg.key && msg.key.remoteJid === '120363406846602793@newsletter') {
                    const serverId = msg.key.server_id || msg.key.serverId || (msg.messageStubType === 145 ? msg.messageStubParameters[0] : null);
                    ...
                    if (serverId) {
                        ...
                        try {
                            ...
                            await sock.newsletterReactions(msg.key.remoteJid, parseInt(serverId), randomEmoji);
                        } catch (e) {
                            try {
                                await sock.newsletterReactions(msg.key.remoteJid, serverId.toString(), randomEmoji);
                            } catch (e2) {}
                        }
                    }
                }
