...
export const smsg = async (conn, m) => {
    ...
    if (m.key) {
        ...
        // En grupos: participant es quien enviÃ³
        // En privado: remoteJid es quien enviÃ³ (nunca participant)
        ...
        // Fallback por si sender quedÃ³ null o @lid
    ...
    if (m.message) {
        ...
        if (m.msg?.contextInfo?.quotedMessage) {
            ...
            // Resolver sender del quoted tambiÃ©n sin @lid
